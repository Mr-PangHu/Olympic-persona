      ...
      <div class="content">
       <el-form :inline="true" :model="formInline" :rules="rules" ref="ruleForm" class="demo-form-inline">
        <el-form-item label="第一大类" prop="firstClass">
         <el-select v-model="formInline.firstClass" placeholder="选择第一大类" filterable clearable @change="getSecondClass"
          @clear="clearFirst" @focus="focusFirst">
        ...
        <el-form-item label="第二大类" prop="secondClass">
         <el-select v-model="formInline.secondClass" @change="getFoodName" @clear="clearSecond" @focus="focusSecond"
          filterable clearable placeholder="选择第二大类">
