  ...
  methods: {
    setWaterChart1 () {
      ...
      option = {
        ...
        xAxis: {
          type: 'category',
          data: ['2022/11/3', '2022/12/8', '2023/1/6', '2023/2/8', '2023/3/9', '2023/4/6'],
          name: '训练日期',
          nameLocation: 'center',
          nameTextStyle: {
            padding: [10, 0, 0, 400]
