...
router.get('/cm/getCounty', cm.getCounty)
router.get('/cm/getCompTypeByCounty', cm.getCompTypeByCounty)
router.get('/cm/getCompNameByType', cm.getCompNameByType)
router.get('/cm/getResults', cm.getResults)
